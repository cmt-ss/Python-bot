...
PAYMENT_CHANNEL = "@cryptopakistanvillage" #add payment channel here including the '@' sign
OWNER_ID = 7060686316 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@cryptopakistanvillage"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
